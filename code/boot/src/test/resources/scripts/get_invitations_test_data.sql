...
VALUES ('Get Invitations Business', 'carretera 1', 'Zahora', 'Cádiz', 'España', 1, 0.0, 0.0, 100.0, 'Europe/Madrid', NOW());
...
INSERT INTO flowrapp_management.business (name, address, town, city, country, owner_id, longitude, latitude, area, timezone_offset, created_at)
VALUES ('Empty Invitations Business',  'carretera 1', 'Zahora', 'Cádiz', 'España', 1, 0.0, 0.0, 100.0, 'Europe/Madrid', NOW());
