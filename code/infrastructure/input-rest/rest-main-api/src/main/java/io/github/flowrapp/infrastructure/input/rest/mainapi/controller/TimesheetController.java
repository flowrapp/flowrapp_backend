...
public class TimesheetController implements TimesheetApi {
  ...
  @Override
  public ResponseEntity<GetWeeklyHoursReport200ResponseDTO> getWeeklyHoursReport(Integer businessId, String week, Integer userId) {
  ...
  @Override
  public ResponseEntity<GetWeeklyHoursReport200ResponseDTO> getCurrentUserWeeklyHoursReport(String week, Integer businessId) {
    val response = timesheetUseCase.getSummaryReport(
        timesheetDTOMapper.rest2domain(null, businessId, week));
